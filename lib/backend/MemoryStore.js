...
class MemoryStore extends EventEmitter {
     ...
     * @returns {Array|null} An array of the droneId's positions or null
     */
     ...
     * @returns {Object|null} An object containing data for all the droneIds positions or null
     */
    getPosition() {
     ...
     * @property {String} position.latitude - Latitude in decimal degrees
     * @property {String} position.longitude - Longitude in decimal degrees
     * @property {String} position.timestamp - Unix timestamp in milliseconds
     */
     ...
     * @property {String} position.id - DroneId
     * @property {String} position.latitude - Latitude in decimal degrees
     * @property {String} position.longitude - Longitude in decimal degrees
     * @property {String} position.timestamp - Unix timestamp in milliseconds 
     */
